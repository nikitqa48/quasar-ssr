<template>
  <div class='container' >
      <p class="text-white" style='text-align:center; font-size:200%; padding-top:5%;' > Истории успеха</p>
      <p class ='text-white'style='text-align:center; opacity:.9; margin:0; padding:0;'> В Липецкой области </p>
     <hooper :settings="hooperSettings" class="hooper" ref="carousel">
      <slide>
        <div class="images img2">
          <div class="wrap">
           <div class="left">
                  <div class="levo">
                       <div class="image" >
               <q-img src ='image/yokohama_mobile.png' class='q-img fit' />
        ...
        <div class="images img2">
          <div class="wrap">
           <div class="left">
                  <div class="levo">
                           <div class="image">
             <q-img src='image/indesit.png' class='q-img fit'/>
             </div>
                    <h5 class="title">
        ...
        <div class="images img2">
          <div class="wrap">
           <div class="left">
                  <div class="levo">
                         <div class="image">
               <q-img src='image/hawle_mobile.png' class='q-img fit'/>
             </div>
                    <h5 class="title">
        ...
        <div class="images img2">
          <div class="wrap">
           <div class="left">
                  <div class="levo">
                     <div class="image" >
               <q-img src='image/angel_mobile.png' style='width:100%; height:100%;' class='q-img fit'/>
