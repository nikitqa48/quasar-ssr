...
<div>        
  ...
  <q-card-section class="q-pt-none">
    ...
    <span style="opacity:.8; color:white; font-size:0.8vw;" class="information" v-html="$t('form.description')">
    </span>
            </div>
          </div>
          ...
          <q-btn :label="$t('form.sendMessage')" rounded type ='submit'   no-caps color="primary" @click="onSubmit"  class="submit"/>
        </q-card-actions>
